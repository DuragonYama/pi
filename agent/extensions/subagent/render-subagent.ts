/**
 * Subagent tool renderCall / renderResult — TUI formatting for single/chain/parallel.
 *
 * Value-imports getMarkdownTheme and pi-tui; not plain-node-importable (agents.ts pattern).
 * Logic is a pure move of the original methods.
 */

import { getMarkdownTheme } from "@earendil-works/pi-coding-agent";
import { Container, Markdown, Spacer, Text } from "@earendil-works/pi-tui";
import { formatLaneInfo, formatToolCall, formatUsageStats, getDisplayItems } from "./format.ts";
import type { AgentScope } from "./agents.ts";
import { getFinalOutput, isFailedResult, type DisplayItem, type SingleResult, type SubagentDetails } from "./types.ts";
